...
const ModPassword = ({ setVisible, savePassword }) => {
  const [btnDisabled, setBtnDisable] = useState(true);
  const [inputType, setInputType] = useState({    //type password/text toggle
    oldKey: "password", 
    newKey: "password",
    reNewKey: "password",
  });
  ...
  const [alertVisible, setAlertVisible] = useState({    //value 경고메세지 표시
    oldKey: true,
    newKey: true,
    newKeyValue: true,
    reNewKey: true,
